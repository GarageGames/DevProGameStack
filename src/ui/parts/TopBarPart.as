...
public class TopBarPart extends UIPart {
	...
	protected function addButtons():void {
		...
		// Designer: Remove the language button as we only support one language
	...
	protected function fixLayout():void {
		var buttonY:int = 5;
		//languageButton.y = buttonY - 1;	// Designer: We don't support this button.

		// new/more/tips buttons
		const buttonSpace:int = 12;
		//var nextX:int = languageButton.x + languageButton.width + 13;
		var nextX:int = 9;	// Designer: We don't support the language button
		fileMenu.x = nextX;
		fileMenu.y = buttonY;
	...
	protected function addTextButtons():void {
		...
		// Designer: About menu
		addChild(aboutMenu = makeMenuButton('About', app.showAboutMenu, false));
	}
